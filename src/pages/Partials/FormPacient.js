...
const FormPacient = ({dataDni, setPage}) => {  //aqui recibo la variable set page
    ...
    const GuardarPaciente = ({dataDni}) => {
        ...
        console.log("dni: ",dnipac, "nombre: ",nompac, "apellido: ",apelpac, "direccion: ", dirpac, "fecnac: ", fnpac, "sexo: ",sexpac,"tlf: ", telpac,"mail:", mailpac);
        if (nompac===""||apelpac===""||dirpac===""||fnpac===""||telpac==="") {          
            MySwal.fire({
                icon: 'warning',
                title: 'Faltan datos!',
            ...
            <div className="row justify-content-md-center">
                <div className="col-lg-6 col-md-6 col-sm-6">
                    <div className="card text-center shadow">
                        <div className="card-header text-uppercase" style={{backgroundColor: "#a93aad", color: "white"}}>
                        ...
                        <form className="text-left" id="form_patient">
                            ...
                            <div className="form-row">
                                <div className="form-group col-md-6">
                                    ...
                                    <Input type="text" className="form-control" id="pac_document" value={dataDni} disabled/>
                                </div>
                            ...
                            <div className="form-row">
                                <div className="form-group col-md-6">
                                    ...
                                    <Input type="text" className="form-control" id="pac_name" required="required" autoComplete="off" onChange={hsetnompac} value={nompac} disabled />
                                </div>
                                <div className="form-group col-md-6">
                                    <Label for="pac_lastname">Apellidos</Label>
                                    <Input type="text" className="form-control" id="pac_lastname" placeholder="" required="required" autoComplete="off" onChange={hsetapelpac} value={apelpac} disabled />
                                </div>
                            </div>
                            <div className="form-group">
                                <Label for="pac_address">Dirección</Label>
                                <textarea className="form-control" id="pac_address" onChange={hsetdirpac} value={dirpac}></textarea>
                            </div>
                            <div className="form-row">
                                <div className="form-group col-md-6">
                                    <Label for="pac_fech_nac">Fecha Nacimiento</Label>
                                    <Input type="date" className="form-control" id="pac_fech_nac" autoComplete="off" onChange={hsetfnpac} />
                                </div>
                                <div className="form-group col-md-6">
                                    <Label for="pac_sex">Sexo</Label>
                                    <select className="form-control" id="pac_sex" required onChange={hsetsexpac}>
                            ...
                            <div className="form-row">
                                <div className="form-group col-md-3">
                                    ...
                                    <Input type="text" className="form-control" id="pac_phone" required="required" autoComplete="off" onChange={hsettelpac} value={telpac} />
                                </div>
                                <div className="form-group col-md-9">
                                    <Label for="pac_email">Correo</Label>
                                    <Input type="email" className="form-control" id="pac_email" onChange={hsetmailpac} value={mailpac} />
                                </div>
                                {/* <div className="form-group col-md-3">
                            ...
                            <div className="modal-footer">
                                <Button color="info" onClick={GuardarPaciente}>Guardar</Button>
                                &nbsp;&nbsp;&nbsp;&nbsp;
                                <Button color="secondary" onClick={() => setPage(0)}>Salir</Button>     
